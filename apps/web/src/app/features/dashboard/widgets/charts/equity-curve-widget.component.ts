    ...
    <div class="p-4 h-full flex flex-col">
      <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
        ...
        <div class="timeframe-selector">
          <p-selectButton [options]="dataService.timeframeOptions" [ngModel]="dataService.selectedTimeframe()" (ngModelChange)="dataService.onTimeframeSelect($event)" optionLabel="label" optionValue="value" class="timeframe-buttons">
