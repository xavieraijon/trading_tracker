...
@Component({
  selector: 'app-long-short-donut-widget',
  standalone: true,
  imports: [CommonModule, ChartModule],
  template: `
    <div class="p-4 h-full flex flex-col">
      <div>
        <h2 class="text-lg font-black tracking-tight m-0">Long vs Short</h2>
        <p class="text-xs text-placeholder mt-1">Distribución de operaciones por dirección</p>
      </div>
      <div class="flex-1 min-h-0 relative mt-2">
        @if (dataService.longShortDonutData(); as data) {
...
export class LongShortDonutWidgetComponent {
