      ...
      <div class="flex flex-col h-full justify-between gap-1">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            <span class="text-[10px] font-bold text-placeholder uppercase tracking-widest">Mayor ganancia</span>
        ...
        <div class="text-2xl font-black font-mono tracking-tighter text-success">
